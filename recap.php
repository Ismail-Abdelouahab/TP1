...
if(isset($_POST['envoyer'])){
    ...
    && isset($filiere) && isset($level) && isset($modules) && isset($nb_projet) && isset($remarque) && isset($clubs) && !empty($_FILES['image']['name'])){
        echo '   
                ...
                <tr><td>Photo d\'identite</td><td>::::</td><td>'.$remarque.'</td></tr>
                 </table>
              </fieldset>';
    }
}
